...
btn3 = types.InlineKeyboardButton("❤️ اشترك في القناة للمزيد من العروض ❤️", url="https://t.me/AliXPromotion")  # btn3 doit être défini avant d'être utilisé
...
# Ajouter les boutons au clavier
keyboardStart.add(btn1, btn2, btn3, btn4, btn5)

# Clavier secondaire pour jeux
...
# Fonction pour gérer les clics sur le bouton "click"
...
# Fonction pour récupérer les liens d'affiliation
def get_affiliate_links(message, message_id, link):
  try:
    ...
    try:
      ...
      bot.send_photo(message.chat.id, img_link, caption=f"🛒 منتجك هو : 🔥 {title_link} 🛍 \n  سعر المنتج : {price_pro} دولار 💵\n\n قارن بين الاسعار واشتري 🔥 \n💰 عرض العملات (السعر النهائي عند الدفع) : {affiliate_link} \n💎 عرض السوبر : {super_links} \n♨️ عرض محدود : {limit_links} \n\n#AliXPromotion ✅", reply_markup=keyboard)
...
# Fonction pour construire le lien du panier
...
# Fonction pour gérer le lien du panier avec des réductions
...
# Fonction principale pour gérer les liens envoyés par les utilisateurs
...
# Fonction pour gérer les réponses aux callback
